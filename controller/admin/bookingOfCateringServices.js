...
module.exports.getbookingCateringServicebyAdmin = async(req,res)=>{
    try {
  ...
  exports.getbookingCateringServicebyRestaurantIdbyAdmin = async (req, res) => {
    try {
  ...
  exports.getbookingCateringServiceByUserIdbyAdmin = async (req, res) => {
    try {
  ...
  module.exports.bookOfCateringServicesByAdmin = async (req, res) => {
    try {
...
module.exports.upadteCateringServiceOfAdmin = async (req, res) => {
  try {
...
exports.deleteCateringervicesById = async (req, res, next) => {
  try {
